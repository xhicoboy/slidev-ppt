---
theme: default
title: v3-2025年度个人年终总结
info: 唐新志 | 研发部 | 前端开发工程师
class: text-center
transition: fade
mdc: true
---
...
<div class="flex flex-col items-center justify-center h-full">
  <h1 class="text-5xl font-bold tracking-wide mb-8" style="color: #4f5d70;">瞬马科技</h1>
  <h2 class="text-4xl font-semibold tracking-wide mb-8" style="color: #404040;">年度绩效考核述职报告</h2>
  <div class="text-xl text-gray-500 font-light tracking-wider">
    汇报人：唐新志 <sb>&emsp;</sb> 汇报时间：2025年12月25日
  </div>
</div>
...
<div class="text-center">
  <div class="flex items-center justify-center gap-4 mb-6">
    ...
    <span class="text-sm text-gray-400 tracking-widest">01</span>
    <div class="w-12 h-px bg-gray-300"></div>
  </div>
...
<div>
  ...
  <div class="flex justify-center items-end gap-16 mb-10">
    <div class="text-center">
      ...
      <div class="text-xs text-gray-400 mt-2">需求完成量</div>
    </div>
    <div class="text-center">
    ...
    <div class="text-center">
      ...
      <div class="text-xs text-gray-400 mt-2">性能提升</div>
    </div>
    <div class="text-center">
      <div class="text-6xl font-bold bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent">6<span class="text-2xl">+</span></div>
      <div class="text-xs text-gray-400 mt-2">业务线并行</div>
    </div>
  </div>

  <div class="grid grid-cols-4 gap-4 max-w-4xl mx-auto text-left">
    <div class="p-4 border border-blue-200 rounded-lg hover:shadow-md transition-shadow">
      <div class="text-sm font-semibold text-gray-800 mb-2">Anonsms</div>
      <div class="text-xs text-gray-500 space-y-1">
        <div>· 星座/早安/道歉/恶作剧/Bulk</div>
        <div>· Anonsms全站性能优化</div>
        <div>· 核心功能的优化重构</div>
      </div>
    </div>
    <div class="p-4 border border-red-200 rounded-lg hover:shadow-md transition-shadow">
      <div class="text-sm font-semibold text-gray-800 mb-2">Reverse Lookup</div>
      <div class="text-xs text-gray-500 space-y-1">
        <div>· ClarityVerify新站</div>
        <div>· 新增马甲1.3-1.8系列</div>
        <div>· 套餐功能迭代</div>
      </div>
    </div>
    <div class="p-4 border border-yellow-200 rounded-lg hover:shadow-md transition-shadow">
      <div class="text-sm font-semibold text-gray-800 mb-2">FMP</div>
      <div class="text-xs text-gray-500 space-y-1">
        <div>· 新增11种多语言落地页</div>
        <div>· SEO内容替换近万行</div>
        <div>· 2个项目重构优化</div>
    ...
    <div class="p-4 border border-green-200 rounded-lg hover:shadow-md transition-shadow">
      <div class="text-sm font-semibold text-gray-800 mb-2">Costext</div>
      <div class="text-xs text-gray-500 space-y-1">
        <div>· 站点性能提升40%</div>
        <div>· 全项目埋点补充</div>
        <div>· 页面组件改造</div>
...
<!-- 
  ...
  性能优化
  加载速度提升 40%：
    在 Costext 项目中，通过精细调整资源加载顺序、启用高效代码压缩工具，成功将页面加载速度提升了 40%，显著改善用户体验 。

  跨越代码边界的排查能力：
    案例：在提测流水线报“内存溢出”时，并未局限于检查代码，而是果断排查环境配置，最终定位并解决了流水线资源限制设置不当的问题 。
  从被动修复到主动防御：
    案例：针对偶发的 500 报错，不满足于临时修复，而是主动推动运维团队在网站上补充详细的运行日志功能，补齐了监控短板，为快速定位问题提供系统性支持 。

  AI 实践：
    代码质量：利用 AI 辅助优化代码逻辑、进行自测及 Review，有效减少了提测缺陷率 。
    效率革命：熟练掌握 AI 指令处理重复性需求，不仅提升了开发效率，更利用业余时间探索 AI 在前端页面自动生成中的应用场景 
-->
...
<div class="text-center">
  <div class="flex items-center justify-center gap-4 mb-6">
    <div class="w-12 h-px bg-gray-300"></div>
    <span class="text-sm text-gray-400 tracking-widest">02</span>
    <div class="w-12 h-px bg-gray-300"></div>
  </div>
...
<!-- 
  500问题
  主动与运维团队沟通，查看服务器运行日志。然而发现之前并未保存完整的运行日志，这给问题排查带来了很大困难。经过与团队协商，我们在网站上补充了详细的运行日志功能，确保后续能及时记录关键信息，为快速定位问题提供有力支持。
  
  内存溢出
  在提测流水线提示内存溢出报错时，起初分析是代码问题，经过排查发现基本排除了代码引发故障的可能；此时，我果断调转思路，开始怀疑是流水线自身配置或资源分配出现偏差，最后发现是流水线某处资源限制设置不当，才导致了内存溢出的报错。
 -->
---
layout: center
---
...
<div class="text-center">  
  <div class="flex items-center justify-center gap-4 mb-6">
    <div class="w-12 h-px bg-gray-300"></div>
    <span class="text-sm text-gray-400 tracking-widest">03</span>
    <div class="w-12 h-px bg-gray-300"></div>
  </div>
...
<!-- 
  #### 收获
    1. **极限交付的成就感**：Q1 完成 50+ 马甲的极限交付，证明了团队的执行力上限
    2. **技术深度的突破**：从单纯完成需求到主动优化性能、沉淀基建
    3. **全局视野的拓展**：支撑多业务线让我对公司海外业务有了更全面的理解
    4. **AI 工具的红利**：AI 辅助开发显著提升了工作效率和代码质量

  #### 挑战
    1. **需求密度高**：High 优先级需求占比 65%+，持续高强度输出
...
<!-- 
  ...
  海外多个站点（Anonsms, FMP等）存在相似功能（如收银台、页眉页脚），建议进一步抽象公共组件，减少重复开发

  多语言
  涉及到非机翻多语言文案替换，需要制定一套多语言文案的物料和脚本，或者其他方式，方能更高提高效率。

  review
  代码多人经手可能会有人不了解最新的代码结构，导致review时出现疏漏。以及review需说明是做了什么需求等等
...
<div class="text-center">
  <div class="flex items-center justify-center gap-4 mb-6">
    <div class="w-12 h-px bg-gray-300"></div>
    <span class="text-sm text-gray-400 tracking-widest">04</span>
    <div class="w-12 h-px bg-gray-300"></div>
  </div>
  <h2 class="text-5xl font-bold text-gray-800 mb-8">未来规划</h2>
  <div class="flex justify-center gap-8 text-sm">
    <span class="text-gray-600">工作规划与展望</span>
  </div>
</div>
...
<div class="font-light">
  ...
  <div class="text-sm tracking-widest text-gray-500 font-medium">唐新志 · 2025</div>
</div>